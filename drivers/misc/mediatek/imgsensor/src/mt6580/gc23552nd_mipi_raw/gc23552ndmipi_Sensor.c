...
#include "gc23552ndmipi_Sensor.h"

#include <mach/gpio_const.h>
#include <mt-plat/mt_gpio.h>

#ifndef GC2355MIPI_2Lane
...
static void GC2355ZGXGetGpioStatus(void)
{
     int ret;
     printk("ZGX gc2355emea2ndZGXGetGpioStatus\n");
     mt_set_gpio_mode(GPIO69, GPIO_MODE_00);
     mt_set_gpio_dir(GPIO69, GPIO_DIR_IN);
     ret = mt_get_gpio_in(GPIO69);
     printk("zgx_gpio_ret_2355_emea2nd = %d\n",ret);
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
			//GC2355ZGXGetGpioStatus();
			printk("i2c write id: 0x%x,zgx sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            if (*sensor_id == imgsensor_info.sensor_id) {
                LOG_INF("i2c write id: 0x%x, zgx1 sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
               // return ERROR_NONE;
			   break; 
            }
    ...
    if (*sensor_id != imgsensor_info.sensor_id) {
		printk("xxxxxxxxxxxxxxxxxxxxxxxx zgx \n");
        ...
        *sensor_id = 0xFFFFFFFF;
    	...
    	{
			GC2355ZGXGetGpioStatus();
			printk("sssssssssssssssssssszgx \n");
			if(mt_get_gpio_in(GPIO69))
				{
					printk("zgx error latae gc2355 start\n");
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
			}
...
UINT32 GC23552ND_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
