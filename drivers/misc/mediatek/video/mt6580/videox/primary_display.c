...
/* [PLATFORM]-Add-BEGIN by TCTSZ.lizhi.wu, 2015.12.12*/
#include <mt-plat/mt6580/include/mach/gpio_const.h>
#include <mt-plat/mt_gpio.h>
#ifndef GPIO_LCM_DSI_TE_PIN
...
/* [PLATFORM]-Add-END by TCTSZ.lizhi.wu, 2015.12.12*/
...
int primary_display_esd_check(void)
{
	...
	printk(KERN_CRIT"[ESD]LCD ESD check!\n");				/* [PLATFORM]-Add by TCTSZ.lizhi.wu, 2015.12.12*/
	_primary_path_lock(__func__);
...
static int primary_display_esd_check_worker_kthread(void *data)
{
	...
	while (1) {
		...
		if (ret == 1) {
			...
			printk(KERN_CRIT"[ESD]esd check fail, will do esd recovery\n");		/* [PLATFORM]-Add by TCTSZ.lizhi.wu, 2015.12.12*/
			i = esd_try_cnt;
			while (i--) {
				...
				if (ret == 0) {
					...
					printk(KERN_CRIT"[ESD]esd recovery success\n");		/* [PLATFORM]-Add by TCTSZ.lizhi.wu, 2015.12.12*/
					break;
				}
				//pr_debug("[ESD]after esd recovery, esd check still fail\n");
				printk(KERN_CRIT"[ESD]after esd recovery, esd check still fail\n");	/* [PLATFORM]-Add by TCTSZ.lizhi.wu, 2015.12.12*/
				if (i == 0) {
					DISPERR(
...
void primary_display_esd_check_enable(int enable)
{
	...
	/* [PLATFORM]-Removed-BEGIN by TCTSZ.lizhi.wu, 2015.12.12*/
	#if 0
	...
	#endif
	/* [PLATFORM]-Removed-END by TCTSZ.lizhi.wu, 2015.12.12*/
		if (enable) {
