...
//[BUGFIX]-Mod-BEGIN by SCDTABLET.zhengding.chen@tcl.com,02/16/2016,PR-1590118
//modify NTC and bms 
static void set_warm_temp_charging_current(void)
{
	if(g_batt_temp_status == TEMP_POS_WARM){
		g_temp_CC_value = CHARGE_CURRENT_700_00_MA;	/* for warm temp */
		battery_log(BAT_LOG_CRTI, "[set_warm_temp_charging_current] set charging current : %d\r\n",
			    g_temp_CC_value);				
	}
}
//[BUGFIX]-Mod-END by SCDTABLET.zhengding.chen@tcl.com,02/16/2016,PR-1590118
...
//modify NTC and bms 
#else
		set_warm_temp_charging_current();
//[BUGFIX]-Mod-END by SCDTABLET.zhengding.chen@tcl.com,02/16/2016,PR-1590118	
#endif
	}
}
...
#else
	{
/*[FEATURE]-MOD-BEGIN by huichen@tcl.com, 2015/12/08 pr 1064094 */
	#if 0
